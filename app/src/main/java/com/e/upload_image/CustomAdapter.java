...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Picasso.with(context).load(mList.get(position).getImage()).placeholder(R.drawable.image).into(holder.imageView);
        // its use for show the image in Activity...after seletion..
